...
class BookAutoCreateDomainObjectContainerDelegate {
    private final Object owner;
    private final BooksContainer container;
    private final DynamicObject delegate;
    private final ThreadLocal<Boolean> configuring = new ThreadLocal<Boolean>()

    public BookAutoCreateDomainObjectContainerDelegate(Object owner, BooksContainer container) {
	...
	void setProperty(String property, Object newValue) {
        try {
            container.setProperty(property,newValue)//."$property" = newValue
        } catch (groovy.lang.MissingPropertyException e) {
            // Ignore
        }
